...
class Admin extends CI_Controller
{
    ...
    public function role()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('flash','New Role Added');
            redirect('admin/role');
        }
    }
    ...
    public function changeAccess()
    {
        ...
        $this->session->set_flashdata('flash','Change Acces Done'); 
    }
    ...
    public function user()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('flash','New User Added'); 
            redirect('admin/user');
        }
    }
    ...
    public function unit()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('flash','New Unit Added');
            redirect('admin/unit');
        }
    }
